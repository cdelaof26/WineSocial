...
* Añadir un usuario nuevo a la comunidad. Los datos básicos de un usuario son:
...
* Cambiar los datos básicos de nuestro perfil de usuario.

* Borrar nuestro perfil.

* Obtener una lista de todos los usuarios en la aplicación. Esta lista debe permitir ser
